package com.example.user.kotlinsubmisi2.View.Adapter
...
import com.example.user.kotlinsubmisi2.R.id.team_badge
import com.example.user.kotlinsubmisi2.R.id.team_name
